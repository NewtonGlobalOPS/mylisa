...
-- CreateIndex
CREATE UNIQUE INDEX "CurriculumObjective_code_key" ON "CurriculumObjective"("code");
...
-- AddForeignKey
ALTER TABLE "CurriculumSource" ADD CONSTRAINT "CurriculumSource_organisationId_fkey" FOREIGN KEY ("organisationId") REFERENCES "Organisation"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CurriculumObjective" ADD CONSTRAINT "CurriculumObjective_sourceId_fkey" FOREIGN KEY ("sourceId") REFERENCES "CurriculumSource"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContentChunk" ADD CONSTRAINT "ContentChunk_sourceId_fkey" FOREIGN KEY ("sourceId") REFERENCES "CurriculumSource"("id") ON DELETE SET NULL ON UPDATE CASCADE;
